      ...
      case 'images':
        return (
          <div className="grid grid-cols-3 gap-1 p-2">
            ...
            {images.map(m => (
              <a key={m.MessageId} href={m.FileUrl || m.FileName} target="_blank" rel="noopener noreferrer" className="aspect-square bg-slate-100 rounded-lg overflow-hidden border border-slate-200 hover:opacity-80 transition-opacity">
      ...
      case 'videos':
        return (
          <div className="grid grid-cols-2 gap-2 p-2">
            ...
            {videos.map(m => (
              <a key={m.MessageId} href={m.FileUrl || m.FileName} target="_blank" rel="noopener noreferrer" className="aspect-square bg-slate-800 rounded-lg overflow-hidden relative flex items-center justify-center group">
      ...
      case 'files':
        return (
          <div className="flex flex-col gap-2 p-2">
            ...
            {files.map(m => (
              <a key={m.MessageId} href={m.FileUrl || m.FileName} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-white border border-slate-200 rounded-xl hover:bg-blue-50 hover:border-blue-200 transition-colors">
